...
import '../../../repository/journals_repository/journals_repository.dart';
import '../../../repository/user_repository/user_repository.dart';
import '../models/journal_model.dart';
import 'journaling_screen.dart';

class TextEditorScreen extends StatefulWidget {
  TextEditorScreen({super.key, required this.createdAt, required this.editEnabled});
  Timestamp createdAt;
  bool editEnabled;
  ...
  void initState() {
    ...
    _journalsController.todayJournalExists().then((result){
      ...
      if (result) {
        ...
        _journalsController.getUserSpecificJournalData(
            widget.createdAt.toDate()).then((result) {
          _journal = result;
          setState(() {
            isLoading = false;
        ...
        _journal = JournalModel(user: _authRepo.getUserEmail, text: "", title: "Today's Journal", createdAt: Timestamp.now());
...
isLoading = false;
    ...
    _journal = JournalModel(user: "", text: "", title: "Loading Journal...", createdAt: Timestamp.now());
  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
      appBar: AppBar(
        ...
        actions: [
        Visibility(visible: widget.editEnabled, child: IconButton(
      ...
      body: Container(
          ...
          padding: const EdgeInsets.all(16.0),
                  ...
                  child:Column(children : [  Visibility(visible: !isLoading, child: TextField(
                    enabled: widget.editEnabled,
      ...
      floatingActionButton:Visibility(visible: widget.editEnabled,
